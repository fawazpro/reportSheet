            ...
            <ul id="slide-out" class="sidenav">
                ...
                <li>
                    <ul class="collapsible p-t-30">
                        <li>
                            <a href="<?= base_url('admin/add_student') ?>" class="collapsible-header"><i class="material-icons">person</i><span class="hide-menu">Student</span></a>
                        </li>
                        <li>
                        ...
                        <!-- <li> -->
                            <!-- <a href="<?= base_url('admin/comment') ?>" class="collapsible-header"><i class="material-icons">lightbulb_outline</i><span class="hide-menu">Principal Comment</span></a> -->
                        <!-- </li> -->
                        <li>
                            <a target="_blank" href="<?= base_url('admin/reportS') ?>" class="collapsible-header"><i class="material-icons">note_add</i><span class="hide-menu">Report Sheet</span></a>
                        </li>
                    </ul>
                </li>
            </ul>
